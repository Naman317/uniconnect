...
const blockUserController = async (req, res, next) => {
    ...
    try {
        ...
        const [userToBlock, loggedInUser] = await Promise.all([
        ...
        await Promise.all([loggedInUser.save(), userToBlock.save()]);
...
const uploadCoverPictureController=async(req,res,next)=>{
 ...
 module.exports={getUserController, updateUserController,followUserController  ,unfollowUserController,  blockUserController
     ,unblockUserController ,  getBlockedUsersController ,deleteUserController
